...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li
                class="nav-item {{ Request::is('category*') ? ' active' : '' }} {{ Request::is('brand*') ? ' active' : '' }} {{ Request::is('product*') ? ' active' : '' }}">
                ...
                <div id="collapseTwo"
                    class="collapse {{ Request::is('category*') ? ' show' : '' }} {{ Request::is('brand*') ? ' show' : '' }} {{ Request::is('product*') ? ' show' : '' }}"
                    aria- labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">PRODUCTS</h6>
                        <a class="collapse-item {{ Request::is('category*') ? ' active' : '' }}"
                            href="{{ route('category.index') }}">CATEGORIES</a>
                        <a class="collapse-item {{ Request::is('brand*') ? ' active' : '' }}"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>E-commerce &copy; 2023 Created by TA</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
