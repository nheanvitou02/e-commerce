            ...
            <div class="col-md-12">
                <div class="card border-0 shadow">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold"><i class="fas fa-shopping-bag"></i> Create Product</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{ old('title') }}" placeholder="Name"
                                            class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="level" class="form-control">
                                            <option value="medium">Select level</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Price <span style="color : red"> *</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control content" name="content" rows="12" placeholder="Description">{{ old('content') }}</textarea>
